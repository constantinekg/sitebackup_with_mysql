...
def makeinnobackup():
    process = subprocess.Popen(["/usr/bin/innobackupex", '--user='+dbuser, '--password='+dbpass, '--no-timestamp', backuplocation], stdout=subprocess.PIPE)
    process.communicate()[0]
    return (process.returncode)
 
# Make log transaction of backup
def makeabackuppplylog():
    print ('Make log transaction')
    process = subprocess.Popen(["/usr/bin/innobackupex", '--apply-log', backuplocation], stdout=subprocess.PIPE)
    print ('---------------------------------------------------------------------------------------------------------')
    process.communicate()[0]
